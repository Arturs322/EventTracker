...
namespace EventTracker.Application.ServiceContracts.Category
{
	...
	public interface ICategoryService
	{
		...
		Task<ServiceResponseDto> CreateCategory(CategoryDto categoryDto);
		...
		Task<ServiceResponseDto> EditCategory(int id, CategoryDto category);
		...
		Task<ServiceResponseDto> DeleteCategory(int id);
	}
}
